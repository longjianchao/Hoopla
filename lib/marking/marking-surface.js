...
(function() {
  ...
  insertStyle = (function() {
    ...
    return function(id, styleContent) {
      ...
      head.insertAdjacentHTML('beforeBegin', "<span id=\"" + IE_HACK_ID + "\"></span>\n<style id=\"" + id + "\">" + styleContent + "</style>");
  ...
  Tool = (function(_super) {
    ...
    // 确保工具始终显示在最前面
    Tool.prototype.toFront = function() {
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.addTool = function(tool) {
      ...
      if(tool instanceof MarkingSurface.EllipseTool && this.tools.length>=1){
        console.log("椭圆工具数量超过1个，不再添加");
        return;
      }
